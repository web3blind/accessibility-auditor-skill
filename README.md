...
Built by a blind developer. Based on WCAG 2.1, WCAG 2.2, GOST R 52872-2019, and the Russian Mincifry accessibility order.
...
4. Maps findings to WCAG 2.1 / WCAG 2.2 / GOST R 52872-2019 criteria
...
- WCAG 2.2 new criteria (2.4.11, 2.4.13, 2.5.7, 2.5.8, 3.2.6, 3.3.7, 3.3.8)
- GOST R 52872-2019 / Mincifry order compliance
- HTML structure, ARIA, keyboard navigation, contrast hints, forms
- Modals and dialogs: full accessible pattern checklist
...
- **WCAG 2.2** — new criteria fully covered: focus appearance, target size, dragging alternatives, consistent help, redundant entry, accessible authentication
...
- **PDF/UA (ISO 14289-1)** — PDF accessibility checks
- **Apple HIG / Android Material** — mobile-specific practical checks
...
└── references/
    ...
    ├── additional-checks.md        # WCAG 2.2, PDF/UA, modals, mobile HIG
